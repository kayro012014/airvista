    ...
    public partial class Test : Migration
    {
     ...
     columns: table => new
     {
         Id = table.Column<int>(nullable: false)
             .Annotation("SqlServer:Identity", "1, 1"),
         FlightCode = table.Column<string>(nullable: false),
         AirlineId = table.Column<int>(nullable: false),
         AircraftCode = table.Column<string>(nullable: false),
         FromAirportId = table.Column<int>(nullable: false),
         ToAirportId = table.Column<int>(nullable: false),
         DepartureDateTime = table.Column<DateTime>(nullable: false),
         EstimatedArrivalDateTime = table.Column<DateTime>(nullable: false),
     ...
     constraints: table =>
     {
         ...
         table.ForeignKey(
             ...
             principalColumn: "Id",
             onDelete: ReferentialAction.NoAction); // 👈 FIX: No Cascade
         table.ForeignKey(
